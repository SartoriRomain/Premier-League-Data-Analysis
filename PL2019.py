...
res=requests.get('https://www.skysports.com/premier-league-table/2019',
                headers=user_agent)
...
df.to_csv("PL2019.csv")
df.to_csv

#We now clean the datas by removing useless columns and replacing wrong team names
data2019 = pd.read_csv("PL2019.csv")
data2019

data2019 = data2019.iloc[:, 2:]
data2019

data2019 = data2019.iloc[:, :9]
data2019

data2019['Team'] = data2019['Team'].replace({'\nLiverpool\n': 'Liverpool',
                                    '\nArsenal\n': 'Arsenal',
                                    '\nManchester City\n': 'Manchester City',
                                    '\nAston Villa\n': 'Aston Villa',
                                    '\nTottenham Hotspur\n': 'Tottenham Hotspur',
