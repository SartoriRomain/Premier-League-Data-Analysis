...
res=requests.get('https://www.skysports.com/premier-league-table/2022',
                headers=user_agent)
...
df.to_csv("PL2022.csv")
df.to_csv

#We now clean the datas by removing useless columns and replacing wrong team names

data2022 = pd.read_csv("PL2022.csv")
data2022

data2022 = data2022.iloc[:, 2:]
data2022

data2022 = data2022.iloc[:, :9]
data2022

data2022['Team'] = data2022['Team'].replace({'\nLiverpool\n': 'Liverpool',
                                    '\nArsenal\n': 'Arsenal',
                                     '\nManchester City\n': 'Manchester City',
                                     '\nAston Villa\n': 'Aston Villa',
                                     '\nTottenham Hotspur\n': 'Tottenham Hotspur',
