...
res=requests.get('https://www.skysports.com/premier-league-table/2020',
                headers=user_agent)
...
df.to_csv("PL2020.csv")
df.to_csv

#We now clean the datas by removing useless columns and replacing wrong team names

data2020 = pd.read_csv("PL2020.csv")
data2020

data2020 = data2020.iloc[:, 2:]
data2020

data2020 = data2020.iloc[:, :9]
data2020

data2020['Team'] = data2020['Team'].replace({'\nLiverpool\n': 'Liverpool',
                                    '\nArsenal\n': 'Arsenal',
                                     '\nManchester City\n': 'Manchester City',
                                     '\nAston Villa\n': 'Aston Villa',
                                     '\nTottenham Hotspur\n': 'Tottenham Hotspur',
