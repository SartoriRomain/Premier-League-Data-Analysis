...
res=requests.get('https://www.skysports.com/premier-league-table/2023',
                headers=user_agent)
...
df.to_csv("PL2023.csv")
df.to_csv

#We now clean the datas by removing useless columns and replacing wrong team names

data2023 = pd.read_csv("PL2023.csv")
data2023

data2023 = data2023.iloc[:, 2:]
data2023

data2023 = data2023.iloc[:, :9]
data2023

data2023['Team'] = data2023['Team'].replace({'\nLiverpool\n': 'Liverpool',
                                    '\nArsenal\n': 'Arsenal',
                                     '\nManchester City\n': 'Manchester City',
                                     '\nAston Villa\n': 'Aston Villa',
                                     '\nTottenham Hotspur\n': 'Tottenham Hotspur',
